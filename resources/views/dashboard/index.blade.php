                ...
                <div class="col-4">
                    <div style="background-color: rgba(216, 216, 216, 0.377)" class="card border-0  text-center">
                        <div class="card-body text-center">
                            ...
                            <h4 class="card-title m-2 text-secondary">{{ $count_menu }} Menues</h4>
                ...
                <div class="col-4">
                    <div style="background-color: rgba(216, 216, 216, 0.377)" class="card border-0  text-center">
                        <div class="card-body text-center">
                            ...
                            <h4 class="card-title m-2 text-secondary">{{ $count_product }} Products</h4>
                ...
                <div class="col-4">
                    <div style="background-color: rgba(216, 216, 216, 0.377)" class="card border-0  text-center">
                        <div class="card-body text-center">
                            ...
                            <h4 class="card-title m-2 text-secondary">{{ $count_blog }} Blogs</h4>
